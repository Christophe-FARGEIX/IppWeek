...
public class IppWeekApp {

    private static final Logger log = LoggerFactory.getLogger(IppWeekApp.class);

    private final Environment env;

    public IppWeekApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(IppWeekApp.class);
