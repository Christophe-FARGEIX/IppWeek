...
import { Parcours, ParcoursService } from '../parcours';
...
export class SiteDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.parcoursService.query()
            .subscribe((res: ResponseWrapper) => { this.parcours = res.json; }, (res: ResponseWrapper) => this.onError(res.json));
    }
    ...
    trackParcoursById(index: number, item: Parcours) {
        return item.id;
    }
}
